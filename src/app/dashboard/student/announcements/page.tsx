...
import { Bell, Search, Filter, Megaphone } from "lucide-react";
...
export default async function StudentAnnouncementsPage({
  ...
  return (
    <div className="portal-shell space-y-6">
      <DashboardTopbar
        title="Announcements"
        subtitle="Read school notices, academic reminders, and important student updates."
            ...
            <div className="space-y-4 text-white">
              ...
              <div className="space-y-3">
                ...
                <p className="max-w-2xl text-sm leading-6 text-blue-50/90 md:text-base">
                  Read important school updates, reminders, and announcements
