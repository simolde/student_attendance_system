  ...
  return (
    <div className="portal-shell space-y-6">
      <DashboardTopbar
        ...
        subtitle="Manage your student account details and portal preferences."
            ...
            <div className="space-y-4 text-white">
              ...
              <div className="space-y-3">
                <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
                  Configure your student portal preferences
                </h1>
                <p className="max-w-2xl text-sm leading-6 text-blue-50/90 md:text-base">
                  Review your account identity, student portal preferences, and
          ...
          <Card className="portal-card">
            ...
            <CardContent className="space-y-4 pt-0">
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Student attendance reminders and portal notices can be managed here later.
                </p>
              </div>
              ...
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Important school and student notices can be configured here.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="portal-card">
            ...
            <CardContent className="space-y-4 pt-0">
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  The student portal currently uses the desktop school portal theme.
                </p>
              </div>
              ...
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Student dashboard preferences and layout options can be added here later.
                </p>
              </div>
            </CardContent>
          </Card>
