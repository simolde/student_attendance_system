...
export default async function SettingsPage() {
  ...
  return (
    <div className="portal-shell space-y-6">
      <DashboardTopbar
        title="Settings"
        subtitle="Manage account details, access information, and portal preferences."
            ...
            <div className="space-y-4 text-white">
              ...
              <div className="space-y-3">
                <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
                  Configure your account and portal preferences
                </h1>
                <p className="max-w-2xl text-sm leading-6 text-blue-50/90 md:text-base">
                  Review account identity, security details, and future portal
                  preferences from one desktop settings page.
                </p>
              </div>
            </div>
          ...
          <Card className="portal-card">
            ...
            <CardContent className="space-y-4 pt-0">
                ...
                <div className="flex items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-600">
                      Review your password and update it if needed.
                    </p>
                  </div>
              ...
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Additional account security features can be added here later,
                  such as 2-step verification or sign-in activity logs.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="portal-card">
            ...
            <CardContent className="space-y-4 pt-0">
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Future attendance reminders and status alerts can be managed here.
                </p>
              </div>
              ...
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Control how notices and updates are shown in your portal.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="portal-card">
            ...
            <CardContent className="space-y-4 pt-0">
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  The portal is currently using the desktop school portal theme.
                </p>
              </div>
              ...
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Theme mode, density, and color preferences can be added here later.
                </p>
              </div>
            </CardContent>
          </Card>
