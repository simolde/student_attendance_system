...
const announcements = [
  {
    id: "1",
    title: "Submit attendance before end of class day",
    excerpt:
      "Teachers are reminded to finalize attendance records and verify late, absent, and excused statuses before day-end.",
    category: "Attendance",
    isPinned: true,
  ...
  {
    id: "2",
    title: "Quarterly grading consultation schedule",
    excerpt:
      "Advisers should review the consultation and grading coordination schedule with their department heads.",
    category: "Academic",
    isPinned: false,
  ...
  {
    id: "3",
    title: "Upcoming campus activity support",
    excerpt:
      "Selected class advisers will assist in student supervision for the scheduled school event this week.",
    category: "Event",
    isPinned: false,
  ...
  return (
    <div className="portal-shell space-y-6">
      <DashboardTopbar
        ...
        subtitle="Review school and classroom notices relevant to teachers."
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
                  Stay updated with teacher notices
                </h1>
                <p className="max-w-2xl text-sm leading-6 text-blue-50/90 md:text-base">
                  Review attendance reminders, school notices, and academic updates
            ...
            <CardContent className="space-y-4 pt-0">
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-3 text-sm leading-6 text-slate-700">
                  Watch class attendance reminders and submission deadlines.
                </p>
              </div>
              ...
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-3 text-sm leading-6 text-slate-700">
                  Teaching schedules and consultation notices can be shown here.
                </p>
              </div>
            </CardContent>
          </Card>
