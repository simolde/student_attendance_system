...
const helpItems = [
  {
    ...
    description:
      "Select a section and date, load students, then save present, late, absent, or excused entries.",
    icon: ClipboardCheck,
  },
  {
    title: "Attendance History",
    description:
      "Review saved attendance records, confirm status updates, and inspect previous entries.",
    icon: ScrollText,
  },
  {
    title: "Teacher Reports",
    description:
      "Check attendance summaries by section and use reports for class-level review.",
    icon: FileBarChart2,
  },
  {
    title: "Announcements",
    description:
      "Read reminders for attendance submission, academic schedules, and school events.",
    icon: Bell,
  },
];
...
export default async function TeacherHelpPage() {
  ...
  return (
    <div className="portal-shell space-y-6">
      <DashboardTopbar
        title="Teacher Help"
        subtitle="Quick guidance for attendance and classroom portal workflows."
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
                  Help for teacher workflows
                </h1>
                <p className="max-w-2xl text-sm leading-6 text-blue-50/90 md:text-base">
                  Use this page as a quick guide for recording attendance, checking history,
                  reviewing reports, and reading school notices.
                </p>
              </div>
            </div>
        ...
        <CardContent className="space-y-4 pt-0">
          <div className="portal-card-soft p-4">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600">
              Start with attendance recording, verify saved entries in history, then review section reports when needed.
            </p>
          </div>
        </CardContent>
      </Card>
