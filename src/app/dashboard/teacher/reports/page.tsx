  ...
  return (
    <div className="portal-shell space-y-6">
      <DashboardTopbar
        ...
        subtitle="Review class attendance summaries and section-based totals."
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
                  Attendance reporting by section
                </h1>
                <p className="max-w-2xl text-sm leading-6 text-blue-50/90 md:text-base">
                  Review totals for present, late, absent, and excused students
                  across your assigned sections.
                </p>
              </div>
            </div>
