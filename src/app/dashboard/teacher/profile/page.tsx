  ...
  return (
    <div className="portal-shell space-y-6">
      <DashboardTopbar
        ...
        subtitle="View your teacher account details and portal identity."
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
                  Your teacher portal profile
                </h1>
                <p className="max-w-2xl text-sm leading-6 text-blue-50/90 md:text-base">
                  Review your account identity and portal information in the teacher dashboard.
                </p>
              </div>
            </div>
          ...
          <CardContent className="space-y-4 pt-0">
            <div className="portal-card-soft p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Your account is linked to attendance recording and teacher portal tools.
              </p>
            </div>
            ...
            <div className="portal-card-soft p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Future teacher-specific preferences can be connected here later.
              </p>
            </div>
          </CardContent>
        </Card>
