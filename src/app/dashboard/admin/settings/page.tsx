  ...
  return (
    <div className="portal-shell space-y-6">
      <DashboardTopbar
        ...
        subtitle="Manage administrator account details, security, and portal preferences."
            ...
            <div className="space-y-4 text-white">
              ...
              <div className="space-y-3">
                ...
                <p className="max-w-2xl text-sm leading-6 text-blue-50/90 md:text-base">
                  Review your account identity, security settings, notifications,
                  and future administrator personalization options.
                </p>
              </div>
            </div>
          ...
          <Card className="portal-card">
            ...
            <CardContent className="space-y-4 pt-0">
                ...
                <div className="flex items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-600">
                      Update your administrator portal password when needed.
                    </p>
                  </div>
              ...
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  More advanced sign-in activity and administrator protection tools can be added later.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="portal-card">
            ...
            <CardContent className="space-y-4 pt-0">
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Attendance, import, RFID, and administrative notices can be configured here later.
                </p>
              </div>
              ...
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Important administrator messages and operational alerts can appear here.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="portal-card">
            ...
            <CardContent className="space-y-4 pt-0">
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  The admin portal currently uses the desktop school portal theme.
                </p>
              </div>
              ...
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  System preferences, maintenance options, and admin-wide controls can be added here later.
                </p>
              </div>
            </CardContent>
          </Card>
