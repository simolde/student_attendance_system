...
export default async function AdminProfilePage() {
  ...
  return (
    <div className="portal-shell space-y-6">
      <DashboardTopbar
        title="Admin Profile"
        subtitle="View your administrator account details and portal identity."
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
                  Your admin portal profile
                </h1>
                <p className="max-w-2xl text-sm leading-6 text-blue-50/90 md:text-base">
                  Review your administrator account identity and portal information
          ...
          <CardContent className="space-y-4 pt-0">
            <div className="portal-card-soft p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Your account has elevated access to management, records, and configuration pages.
              </p>
            </div>
            ...
            <div className="portal-card-soft p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Security options, password updates, and admin preferences can be managed from settings.
              </p>
            </div>
          </CardContent>
        </Card>
