...
const quickLinks = [
  {
    ...
    description: "Review attendance logs and recent daily status.",
    href: "/dashboard/parent/attendance",
    icon: ClipboardList,
  },
  {
    title: "Announcements",
    description: "Read parent notices and school reminders.",
    href: "/dashboard/parent/announcements",
    icon: Bell,
  },
  {
    title: "Parent Settings",
    description: "Manage account preferences and portal options.",
...
export default async function ParentHomePage() {
  ...
  return (
    <div className="portal-shell space-y-6">
      <DashboardTopbar
        title="Parent Home"
        subtitle="Quick access to your parent portal tools."
          ...
          <div className="relative px-6 py-8 text-white md:px-8 md:py-10">
            <div className="space-y-4">
              <div className="inline-flex items-center rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs font-medium backdrop-blur">
                Parent Navigation Hub
              </div>

              <div className="space-y-3">
                <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
                  Start from your parent shortcuts
                </h1>
                <p className="max-w-2xl text-sm leading-6 text-blue-50/90 md:text-base">
                  Open attendance, announcements, and settings quickly from one
                  simple parent home page.
                </p>
              </div>
            </div>
          </div>
      ...
      <Card className="portal-card">
        ...
        <CardContent className="space-y-4 pt-0">
          <div className="portal-card-soft p-4">
            <div className="text-sm font-semibold text-slate-900">Family Access</div>
            <p className="mt-2 text-sm leading-6 text-slate-600">
              Use this page as a simple starting point for parent attendance and communication tools.
            </p>
          </div>
        </CardContent>
      </Card>
