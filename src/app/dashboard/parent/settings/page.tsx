  ...
  return (
    <div className="portal-shell space-y-6">
      <DashboardTopbar
        ...
        subtitle="Manage parent account details and portal preferences."
            ...
            <div className="space-y-4 text-white">
              ...
              <div className="space-y-3">
                <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
                  Configure your parent portal preferences
                </h1>
                <p className="max-w-2xl text-sm leading-6 text-blue-50/90 md:text-base">
                  Review your account identity, communication preferences, and future
                  parent portal settings from one place.
                </p>
              </div>
            </div>
          ...
          <Card className="portal-card">
            ...
            <CardContent className="space-y-4 pt-0">
                ...
                <div className="flex items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-600">
                      Update your parent portal password when needed.
                    </p>
                  </div>
              ...
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Additional login protection and sign-in activity tools can be added here later.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="portal-card">
            ...
            <CardContent className="space-y-4 pt-0">
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Future child attendance alerts and notices can be managed here.
                </p>
              </div>
              ...
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Parent announcement preferences can be added here later.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="portal-card">
            ...
            <CardContent className="space-y-4 pt-0">
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  The parent portal currently uses the desktop school portal theme.
                </p>
              </div>
              ...
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Theme mode and parent dashboard preferences can be added here later.
                </p>
              </div>
            </CardContent>
          </Card>
