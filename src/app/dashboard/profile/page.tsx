...
export default async function ProfilePage() {
  ...
  return (
    <div className="portal-shell space-y-6">
      <DashboardTopbar
        title="Profile"
        subtitle="View your account details and portal identity."
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <p className="max-w-2xl text-sm leading-6 text-blue-50/90 md:text-base">
                  Review your sign-in identity, role, and account summary in the
                  school portal.
                </p>
              </div>
            </div>
          ...
          <CardContent className="space-y-4 pt-0">
            <div className="portal-card-soft p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Your profile data is connected to your current portal session.
              </p>
            </div>
            ...
            <div className="portal-card-soft p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Additional account personalization and edit options can be connected here later.
              </p>
            </div>
          </CardContent>
        </Card>
