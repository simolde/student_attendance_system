...
const announcements = [
  {
    id: "1",
    title: "Attendance support workflow reminder",
    excerpt:
      "Staff assigned to attendance support should review attendance submissions and flagged records before end-of-day validation.",
    category: "Attendance",
    isPinned: true,
  ...
  {
    id: "2",
    title: "Operations coordination update",
    excerpt:
      "Administrative staff are reminded to coordinate with class advisers and registrar-related requests this week.",
    category: "Operations",
    isPinned: false,
  ...
  {
    id: "3",
    title: "Campus event assistance schedule",
    excerpt:
      "Assigned staff members will assist in monitoring entrances, attendance support, and logistics during the upcoming school event.",
    category: "Event",
    isPinned: false,
  ...
  return (
    <div className="portal-shell space-y-6">
      <DashboardTopbar
        ...
        subtitle="Review operations notices, attendance reminders, and staff updates."
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
                  Stay updated with staff notices
                </h1>
                <p className="max-w-2xl text-sm leading-6 text-blue-50/90 md:text-base">
                  Monitor attendance support reminders, operations notices, and
                  school activity updates prepared for staff users.
                </p>
              </div>
            </div>
            ...
            <CardContent className="space-y-4 pt-0">
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-3 text-sm leading-6 text-slate-700">
                  Review flagged attendance reminders and validation notices regularly.
                </p>
              </div>
              ...
              <div className="portal-card-soft p-4">
                ...
                <p className="mt-3 text-sm leading-6 text-slate-700">
                  Watch operations updates and staff coordination notices.
                </p>
              </div>
            </CardContent>
          </Card>
